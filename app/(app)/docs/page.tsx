			...
			<div className="px-4 py-8">
				...
				<div className="border-t pt-8">
					...
					<ul className="list-disc pl-6 space-y-2">
						<li>
							<Link prefetch={true} href="/seo-guide" className="text-primary hover:underline">
								Comprehensive SEO Guide
							</Link>
						</li>
						<li>
							<Link prefetch={true} href="/keyword-research-tools" className="text-primary hover:underline">
								Top Keyword Research Tools
							</Link>
						</li>
						<li>
							<Link prefetch={true} href="/local-seo-tips" className="text-primary hover:underline">
