...
export function AISummary({ summary = "This is an AI-generated summary of the article. It provides a quick overview of the main points discussed in the content below." }) {
	return (
		<div className="not-prose hidden xl:block p-2 rounded-lg shadow-md bg-white dark:bg-gray-800 border-2 border-purple-400 dark:border-purple-500">
			...
			<div className="bg-gray-50 dark:bg-gray-700 rounded-md p-4 shadow-inner">
