      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="lg:flex lg:gap-8">
          <main className="lg:w-2/3">
            <div 
              className="prose prose-primary max-w-none mb-12"
            ...
            <section className="mb-12">
              ...
              <form className="mt-6">
                <label htmlFor="comment" className="block text-sm font-medium text-muted-foreground mb-2">Leave a comment</label>
                <textarea 
                  id="comment"
